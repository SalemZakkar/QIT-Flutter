...
import 'package:qit_flutter/presentation/core/pages/on_board.dart';
...
class _QitFlutterAppState extends State<QitFlutterApp> {
  ...
  void initState() {
    ...
    getIt<AuthBloc>().add(const CheckFirstTime());
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      ...
      child: firstTime ? const OnBoardPage() : const SplashPage(),
    );
  }
}
